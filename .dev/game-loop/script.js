...
// import { Viewport } from '../../src/features/graphic/Viewport.js';
...
const canvas = {
	...
	get templates() { return this.dom.querySelector('#templates') },
	
};
const grid = document.querySelector('.grid');
const appBody = document.querySelector('#app-body')
const containers = document.querySelectorAll('.container')
// const vport = new Viewport(canvas, 'scene', {})

// console.warn('vport', vport)
const DIRECTIONS = [
	[0, -1],
	[1, 0],
	[0, 1],
...
export const renderFPS = (delta = 0) => {
	...
	fpsDisplay.textContent = mainLoop.fps
	return mainLoop.fps
}

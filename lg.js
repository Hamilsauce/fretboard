...
async function loadAudioSamples() {
  const samples = {
    kick: 'https://corsproxy.io/?url=https://10kdrummachines.com/machines/logic-gates/lg-sounds/kick.wav',
    snare: 'https://corsproxy.io/?url=https://10kdrummachines.com/machines/logic-gates/lg-sounds/snare.wav',
    hihat: 'https://corsproxy.io/?url=https://10kdrummachines.com/machines/logic-gates/lg-sounds/hihat.wav',
    clap: 'https://corsproxy.io/?url=https://10kdrummachines.com/machines/logic-gates/lg-sounds/clap.wav'
  };
  
  for (const [name, url] of Object.entries(samples)) {
    try {
      const response = await fetch('https://corsproxy.io/?url=https://10kdrummachines.com/machines/logic-gates/lg-sounds/kick.wav');
